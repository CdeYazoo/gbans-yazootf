				...
				<Link href={`/admin/network/ip_info`}>
					<Paper component={Box}>
						<Stack spacing={2}>
							...
							<Typography variant="body1">
								Get higher level info about a particular ip. This include location, proxy info, ASN
								network blocks that the IP belongs to
							</Typography>
						</Stack>
					</Paper>
				</Link>
				...
				<Link href={`/admin/network/cidr_blocks`}>
					<Paper component={Box}>
						<Stack spacing={2}>
							...
							<Typography variant="body1">
								Used for banning large range of address blocks using 3rd party URL sources. Response
								should be in the format of 1 cidr address per line. Invalid lines are discarded. Use the
								whitelist to override blocked addresses you want to allow.
							</Typography>
						</Stack>
					</Paper>
				</Link>
